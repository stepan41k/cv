export const translations = {
    ru: {
        ...
        job_name_0:
            "ООО «Максима» – референс сервиса на Go для миграции легаси",
        job_list_0: `
          ...
          `,
        job_name_1:
            "Мессенджер для кафедры «Minor» – курсовой/дипломный проект",
        job_list_1: `
    ...
    en: {
        ...
        job_name_1:
            "Messenger for the Minor Department – ​​coursework/graduation project",
        job_list_1: `
        ...
        job_list_3: `
          ...
          `,
        job_name_4:
            "The NovSU Hackathon in collaboration with JSC Splav Corporation – winner (3rd place)",
        job_list_4: `
